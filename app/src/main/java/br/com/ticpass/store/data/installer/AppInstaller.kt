...
import br.com.ticpass.store.data.installer.base.IInstaller
...
class AppInstaller @Inject constructor(
    ...
    companion object {
        const val ACTION_INSTALL_STATUS = "br.com.ticpass.store.data.installer.AppInstaller.INSTALL_STATUS"

        const val EXTRA_PACKAGE_NAME = "br.com.ticpass.store.data.installer.AppInstaller.EXTRA_PACKAGE_NAME"
        const val EXTRA_VERSION_CODE = "br.com.ticpass.store.data.installer.AppInstaller.EXTRA_VERSION_CODE"
        const val EXTRA_DISPLAY_NAME = "br.com.ticpass.store.data.installer.AppInstaller.EXTRA_DISPLAY_NAME"
