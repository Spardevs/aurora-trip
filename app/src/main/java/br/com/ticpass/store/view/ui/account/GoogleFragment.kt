...
package br.com.ticpass.store.view.ui.account
...
import br.com.ticpass.store.databinding.FragmentGoogleBinding
        ...
        binding.webview.apply {
            ...
            webViewClient = object : WebViewClient() {
                override fun onPageFinished(view: WebView, url: String) {
                    ...
                    if (cookies != null) {
                        val cookieMap = br.com.ticpass.store.util.AC2DMUtil.parseCookieString(cookies)
