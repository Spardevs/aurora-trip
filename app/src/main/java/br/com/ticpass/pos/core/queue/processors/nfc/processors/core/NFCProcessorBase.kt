package br.com.ticpass.pos.core.queue.processors.nfc.processors.core
 ...
 * 
 * Subclasses must provide an NFCOperations implementation via constructor injection.
 */
abstract class NFCProcessorBase(
    protected val nfcOperations: NFCOperations
     ...
     * 
     * Uses the injected NFCOperations implementation for SDK-specific detection.
     *
    ...
    protected suspend fun detectTag(timeout: Long = 5000L): NFCTagDetectionResult {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val result = nfcOperations.detectTag(timeout)
