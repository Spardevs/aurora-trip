package br.com.ticpass.pos.presentation.printing
...
import br.com.ticpass.pos.presentation.printing.states.PrintingAction
import br.com.ticpass.pos.presentation.printing.states.PrintingReducer
...
import br.com.ticpass.pos.core.queue.processors.printing.utils.PrintingQueueFactory
...
class PrintingViewModel @Inject constructor(
     ...
     */
    fun confirmPrinterPaperCut(requestId: String, paperCutType: br.com.ticpass.pos.core.queue.processors.printing.models.PaperCutType) {
