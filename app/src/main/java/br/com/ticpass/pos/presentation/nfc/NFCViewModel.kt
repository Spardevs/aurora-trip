package br.com.ticpass.pos.presentation.nfc
...
import br.com.ticpass.pos.presentation.nfc.states.NFCReducer
...
import br.com.ticpass.pos.core.queue.processors.nfc.utils.NFCQueueFactory
...
class NFCViewModel @Inject constructor(
    ...
    fun enqueueCartReadOperation(
        ...
        dispatch(NFCAction.EnqueueTypedNFC(
            NFCQueueItem.CartReadOperation(
                timeout = timeout
            )
        ))
    }
