...
import br.com.ticpass.pos.queue.processors.refund.processors.RefundProcessorRegistry
import kotlinx.coroutines.CoroutineScope

/**
 * Refund Queue Factory
 * Helper class to create configured refund queue instances
 */
class RefundQueueFactory {
