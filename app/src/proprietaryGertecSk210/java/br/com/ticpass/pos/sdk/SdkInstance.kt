...
/**
 * Central holder for the Gertec SK210 SDK instance
 * 
...
object SdkInstance {
    ...
    /**
     * Initialize the Gertec SK210 SDK instance
     * 
    ...
    /**
     * Get the Gertec SK210 SDK instance
     * 
     * @return The initialized SDK instance (context)
     * @throws IllegalStateException if the SDK is not initialized
     */
    fun getInstance(): Context {
        return _instance ?: throw IllegalStateException("Gertec SK210 SDK not initialized. Call initialize() first.")
    }
